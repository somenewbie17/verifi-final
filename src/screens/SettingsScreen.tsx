...
export default function SettingsScreen() {
  ...
  return (
    <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]} edges={['top']}>
      <Text style={[theme.typography.h1, { color: theme.colors.text, marginBottom: 24 }]}>
        Settings
      </Text>
      ...
      <View style={[styles.card, { backgroundColor: theme.colors.card }]}>
        {themeOptions.map((option, index) => (
          <Pressable
            ...
            style={[styles.optionRow, { borderBottomWidth: index === themeOptions.length - 1 ? 0 : 1, borderBottomColor: theme.colors.border }]}
          >
            <Ionicons name={option.icon} size={22} color={theme.colors.textSecondary} />
      ...
      <View style={[styles.card, { backgroundColor: theme.colors.card, padding: 16 }]}>
        ...
        <Text style={[theme.typography.bodyBold, {color: theme.colors.text, marginTop: 4, marginBottom: 16}]}>{user?.email}</Text>
